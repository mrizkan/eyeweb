<?php include ('inc/header.php'); ?>
            ...
            <div class="row">
                <div class="clearfix">
                    ...
                    <div class="col-md-4 marbot10">
                        <h1>
                            <span class="fw-normal">Total Eye Care Services for  </span>  Childrens and Adults
                        </h1>
                    </div>
                    <!-- // Section 1 -->
    ...
    <section class="hospital top-bottom-spacing-full grey-bg" style="margin-bottom: -60px">
        <div class="container">
            <div class="row">
