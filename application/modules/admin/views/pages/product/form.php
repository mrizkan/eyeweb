                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6" style="display: none;">
                                            ...
                                            <img id="img_file" src="https://cdn3.iconfinder.com/data/icons/line-icons-set/128/1-02-48.png" alt="document, download, file, files, pdf icon" width="48" height="48">
                                            <img id="img_load" src="<?= base_url('media/images/30-1.gif') ?>" alt="document, download, file, files, pdf icon" width="48" height="48">
                                            ...
                                            <span class="inner">
                                                ...
                                                <?php if ($obj->Document): ?>
                                                    <a href="<?= base_url('media/doc/').$obj->Document ?>" target="_blank">
